...
CONTENTS OF THIS REPO1.Tidy data set named tidy_dataset.txt 
...
RAW DATA1.Raw Data was obtained from this link https://d396qusza40orc.cloudfront.net/getdata%2Fprojectfiles%2FUCI%20HAR%20Dataset.zip 
...
ABOUT THE SCRIPT
run_analysis.r contains a function to transform the following data sets into a single tidy data set: 1. activity_labels.txt 2. features.txt 3. subject_test.txt 4. subject_train.txt 5. X_test.txt 6. X_train.txt 7. y_test.txt 8. y_train.txt



USAGE1.Ensure the file "run_analysis.r" is in same directory as the 8 files above
